...
export default function LineChart() {
  return (
    <div className="shadow-2xl my-4 flex flex-col w-11/12 items-center rounded-md">
      {/* title chart  */}
      ...
      {/* BarChart  */}
      <div className="bg-white w-full border-14 border-white rounded-bl-md rounded-br-md">
        <div className="bg-gray-200 p-2 h-56 w-full border-white rounded-md">
          <Line
            data={{
              labels: [
                "January",
